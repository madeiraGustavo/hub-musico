...
/**
 * WhatsAppCTA — Botão flutuante de orçamento via WhatsApp.
...
export function WhatsAppCTA() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3 rounded-full shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl group"
      style={{
