...
export async function servicesRoutes(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.patch('/dashboard/services/:id',  { preHandler: authenticate }, updateServiceHandler as RouteHandlerMethod)
  fastify.delete('/dashboard/services/:id', { preHandler: authenticate }, deleteServiceHandler as RouteHandlerMethod)
}
